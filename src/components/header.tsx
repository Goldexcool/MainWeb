...
import profile from '../../public/images/profile.svg.svg';
import saved from '../../public/images/saved.svg.svg';
import cart from '../../public/images/cart.svg.svg';
                ...
                <div className="max-w-7xl w-full flex items-center justify-between lg:px-12 px-2">
                    ...
                    <div className="justify-between items-center bg-[#FBF5EF] rounded-lg p-3 columnGap2 hidden md:flex">
                        ...
                        <div className="flex items-center cursor-pointer">
                            <p className="text-[#0D0D0D] poppins-regular text-[18px] hover:text-[#590209]">
                                Products
                            </p>
                    ...
                    <div className="justify-center gap-5 md:flex hidden items-center">
                        ...
                        <div className="flex justify-center gap-2">
                            ...
                            <p className="md:text-[18px] text-[16px] text-bold">Cart</p>
                        </div>
                    </div>
