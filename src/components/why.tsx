...
import accesssIcon from '../../public/images/accessIcon.svg'
import support from '../../public/images/supportIcon.svg'
import div from '../../public/images/servicesIcon.svg'
import Image from 'next/image'

const Why = () => {
    return (
        <section className='mx-auto mt-[5rem] lg:px-10 px-2'>
